...
for (const name of ['dist', 'native', 'LICENSE', 'README.md']) cpSync(resolve(sdk, name), resolve(staging, name), { recursive: true });
...
pkg.files = ['dist', 'native', 'runtime', 'LICENSE', 'README.md'];
...
mkdirSync(resolve(staging, 'runtime/go'), { recursive: true });
