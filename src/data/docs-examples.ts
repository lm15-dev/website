...
export const RECIPES = {
  ...
  'err-catch': tour('err-catch'),
  'media-photo': tour('media-photo'),
  'media-log': tour('media-log'),
  'gen-short': tour('gen-short'),
  'gen-temperature': tour('gen-temperature'),
  'gen-stop': tour('gen-stop'),
  'gen-adapt': tour('gen-adapt'),
  'gen-plan': tour('gen-plan'),
  'gen-refuse': tour('gen-refuse'),
  'err-retry': tour('err-retry'),
  'err-use': tour('err-use'),
